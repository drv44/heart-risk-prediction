...
svm_model = joblib.load('C:\\Users\\drv\\drv_codes\\ML project\\models\\svm.pkl')
rf_model = joblib.load('C:\\Users\\drv\\drv_codes\\ML project\\models\\randomForest.pkl')
logistic_model = joblib.load('C:\\Users\\drv\\drv_codes\\ML project\\models\\logistic.pkl')
knn_model = joblib.load('C:\\Users\\drv\\drv_codes\\ML project\\models\\knn.pkl')
...
#save the model
joblib.dump(voting_clf, 'C:/Users/drv/drv_codes/ML project/models/ensemble.pkl')